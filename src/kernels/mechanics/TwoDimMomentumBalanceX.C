...
#include "TwoDimMomentumBalanceX.h"

registerMooseObject("gibbsApp", TwoDimMomentumBalanceX);

template <>
InputParameters
validParams<TwoDimMomentumBalanceX>()
{
...
TwoDimMomentumBalanceX::TwoDimMomentumBalanceX(const InputParameters & parameters)
  :Kernel(parameters),
...
Real
TwoDimMomentumBalanceX::computeQpResidual()
{
...
Real
TwoDimMomentumBalanceX::computeQpJacobian()
{
...
Real
TwoDimMomentumBalanceX::computeQpOffDiagJacobian(unsigned int /*jvar*/)
{ 
    return 0;
}
