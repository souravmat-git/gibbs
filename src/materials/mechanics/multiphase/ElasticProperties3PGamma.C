...
#include "ElasticProperties3PGamma.h"
registerMooseObject("gibbsApp", ElasticProperties3PGamma);

//template <>
InputParameters
ElasticProperties3PGamma::validParams()
{
...
ElasticProperties3PGamma::ElasticProperties3PGamma(const InputParameters & parameters)
  : Material(parameters),
