...
#include "ComputeSmallStrain3PGamma.h"
registerMooseObject("gibbsApp", ComputeSmallStrain3PGamma);

//template <>
InputParameters
ComputeSmallStrain3PGamma::validParams()
{
...
ComputeSmallStrain3PGamma::ComputeSmallStrain3PGamma(const InputParameters & parameters)
...
void
ComputeSmallStrain3PGamma::computeQpProperties()
{
  ...
  _mechanical_strain[_qp] += - _h_alpha[_qp] * _strain_jump_alpha_beta[_qp]
                             - (_h_beta[_qp] + _h_alpha[_qp]) * _strain_jump_beta_gamma[_qp];
}
