...
#include "ComputeSmallStrain3PAlpha.h"
registerMooseObject("gibbsApp", ComputeSmallStrain3PAlpha);

template <>
InputParameters
validParams<ComputeSmallStrain3PAlpha>()
{
...
ComputeSmallStrain3PAlpha::ComputeSmallStrain3PAlpha(const InputParameters & parameters)
...
void
ComputeSmallStrain3PAlpha::computeQpProperties()
{
  ...
  _mechanical_strain[_qp] += (_h_beta[_qp] + _h_gamma[_qp]) * _strain_jump_alpha_beta[_qp]
