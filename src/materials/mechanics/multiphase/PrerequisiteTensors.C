...
#include "PrerequisiteTensors.h"
registerMooseObject("gibbsApp", PrerequisiteTensors);

template <>
InputParameters
validParams<PrerequisiteTensors>()
{
...
PrerequisiteTensors::PrerequisiteTensors(const InputParameters & parameters)
...
void
PrerequisiteTensors::computeQpProperties(){
  ...
  else
  {
      ...
      //First initialize L_star to zero
      _L_star.zero();
