...
#include "Q1DAlphaPhaseElasticMaterial.h"
registerMooseObject("gibbsApp", Q1DAlphaPhaseElasticMaterial);

//template <>
InputParameters
Q1DAlphaPhaseElasticMaterial::validParams()
{
...
Q1DAlphaPhaseElasticMaterial::Q1DAlphaPhaseElasticMaterial(const InputParameters & parameters)
  : Material(parameters),
...
void
Q1DAlphaPhaseElasticMaterial::computeQpProperties(){

  //return the stress and the elastic strain energy
  //Here, ex is the compatible strain

   _ex_val[_qp] = (_grad_ux[_qp](0) - _a[_qp] * _h[_qp]);
