...
#include "ComputeMultiPlasticityStressPhase.h"
...
registerMooseObject("gibbsApp", ComputeMultiPlasticityStressPhase);

InputParameters
ComputeMultiPlasticityStressPhase::validParams()
{
...
ComputeMultiPlasticityStressPhase::ComputeMultiPlasticityStressPhase(const InputParameters & parameters)
  : ComputeStressBase(parameters),
    ...
    _linesearch_needed(declareProperty<Real>(_base_name + "plastic_linesearch_needed")), // this is really a
                                                                            ...
                                                                            // visualisation i
                                                                            // convert it to Real
    _ld_encountered(declareProperty<Real>(_base_name +
...
{
  if (_epp_tol <= 0)
    mooseError("ComputeMultiPlasticityStressPhase: ep_plastic_tolerance must be positive");
  ...
  if (_n_supplied)
  {
    ...
    if (_n_input.norm() == 0)
      mooseError(
          "ComputeMultiPlasticityStressPhase: transverse_direction vector must not have zero length");
    else
...
void
ComputeMultiPlasticityStressPhase::initQpStatefulProperties()
{
...
void
ComputeMultiPlasticityStressPhase::computeQpStress()
{
...
RankTwoTensor
ComputeMultiPlasticityStressPhase::rot(const RankTwoTensor & tens)
{
  if (!_n_supplied)
    return tens;
...
void
ComputeMultiPlasticityStressPhase::preReturnMap()
{
  if (_n_supplied)
  {
...
void
ComputeMultiPlasticityStressPhase::postReturnMap()
{
  if (_n_supplied)
  {
...
bool
ComputeMultiPlasticityStressPhase::quickStep(const RankTwoTensor & stress_old,
                                        ...
                                        bool final_step)
{
  ...
  else if (num_plastic_returns == 1 && successful_return)
  {
    ...
    mooseError("ComputeMultiPlasticityStressPhase::quickStep   should not get here!");
}

bool
ComputeMultiPlasticityStressPhase::plasticStep(const RankTwoTensor & stress_old,
                                          RankTwoTensor & stress,
                                          const std::vector<Real> & intnl_old,
                                          std::vector<Real> & intnl,
                                          const RankTwoTensor & plastic_strain_old,
...
bool
ComputeMultiPlasticityStressPhase::returnMap(const RankTwoTensor & stress_old,
                                        RankTwoTensor & stress,
                                        const std::vector<Real> & intnl_old,
                                        std::vector<Real> & intnl,
                                        const RankTwoTensor & plastic_strain_old,
...
bool
ComputeMultiPlasticityStressPhase::canAddConstraints(const std::vector<bool> & act,
...
bool
ComputeMultiPlasticityStressPhase::canChangeScheme(DeactivationSchemeEnum current_deactivation_scheme,
                                              bool can_revert_to_dumb)
{
...
void
ComputeMultiPlasticityStressPhase::changeScheme(const std::vector<bool> & initial_act,
                                           bool can_revert_to_dumb,
...
bool
ComputeMultiPlasticityStressPhase::singleStep(Real & nr_res2,
                                         RankTwoTensor & stress,
                                         const std::vector<Real> & intnl_old,
                                         std::vector<Real> & intnl,
                                         std::vector<Real> & pm,
...
bool
ComputeMultiPlasticityStressPhase::reinstateLinearDependentConstraints(
...
unsigned
ComputeMultiPlasticityStressPhase::numberActive(const std::vector<bool> & active)
{
...
bool
ComputeMultiPlasticityStressPhase::checkAdmissible(const RankTwoTensor & stress,
...
bool
ComputeMultiPlasticityStressPhase::checkKuhnTucker(const std::vector<Real> & f,
...
void
ComputeMultiPlasticityStressPhase::applyKuhnTucker(const std::vector<Real> & f,
                                              const std::vector<Real> & pm,
                                              std::vector<bool> & active)
{
...
Real
ComputeMultiPlasticityStressPhase::residual2(const std::vector<Real> & pm,
...
bool
ComputeMultiPlasticityStressPhase::lineSearch(Real & nr_res2,
                                         RankTwoTensor & stress,
                                         const std::vector<Real> & intnl_old,
                                         std::vector<Real> & intnl,
                                         std::vector<Real> & pm,
...
void
ComputeMultiPlasticityStressPhase::buildDumbOrder(const RankTwoTensor & stress,
                                             const std::vector<Real> & intnl,
                                             std::vector<unsigned int> & dumb_order)
{
...
void
ComputeMultiPlasticityStressPhase::incrementDumb(int & dumb_iteration,
...
bool
ComputeMultiPlasticityStressPhase::canIncrementDumb(int dumb_iteration)
{
...
unsigned int
ComputeMultiPlasticityStressPhase::activeCombinationNumber(const std::vector<bool> & act)
{
  unsigned num = 0;
  for (unsigned surface = 0; surface < _num_surfaces; ++surface)
    if (act[surface])
...
RankFourTensor
ComputeMultiPlasticityStressPhase::consistentTangentOperator(const RankTwoTensor & stress,
                                                        const std::vector<Real> & intnl,
                                                        const RankFourTensor & E_ijkl,
