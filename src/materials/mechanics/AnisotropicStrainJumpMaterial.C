...
#include "AnisotropicStrainJumpMaterial.h"
registerMooseObject("gibbsApp", AnisotropicStrainJumpMaterial);

//template <>
InputParameters
AnisotropicStrainJumpMaterial::validParams()
{
...
AnisotropicStrainJumpMaterial::AnisotropicStrainJumpMaterial(const InputParameters & parameters)
  : Material(parameters),
...
void
AnisotropicStrainJumpMaterial::computeQpProperties(){
