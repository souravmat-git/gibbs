...
#include "FourthRankTensorVoigtNotation.h"
#include "DenseMatrix.h"
#include <fstream>
using namespace std;

registerMooseObject("gibbsApp", FourthRankTensorVoigtNotation);

template<>
InputParameters
validParams<FourthRankTensorVoigtNotation>()
{
...
FourthRankTensorVoigtNotation::FourthRankTensorVoigtNotation(const InputParameters & parameters)
 : Material(parameters),
...
void
FourthRankTensorVoigtNotation::computeQpProperties()
{
  ...
  // Due to major symmetry _C_ijkl = C_klij 
  _V[_qp](1,0) = _V[_qp](0,1);
  _V[_qp](2,0) = _V[_qp](0,2);
  _V[_qp](3,0) = _V[_qp](0,3);
  _V[_qp](4,0) = _V[_qp](0,4);
  _V[_qp](5,0) = _V[_qp](0,5);
  ...
  // Due to major symmetry _C_ijkl = C_klij 
  _V[_qp](2,1) = _V[_qp](1,2);
  _V[_qp](3,1) = _V[_qp](1,3);
  _V[_qp](4,1) = _V[_qp](1,4);
  _V[_qp](5,1) = _V[_qp](1,5);
  ...
  // Due to major symmetry _C_ijkl = C_klij 
  _V[_qp](3,2) = _V[_qp](2,3);
  _V[_qp](4,2) = _V[_qp](2,4);
  _V[_qp](5,2) = _V[_qp](2,5);
  ...
  _V[_qp](4,3) = _V[_qp](3,4);
  _V[_qp](5,3) = _V[_qp](3,5);
  
   // Fifth row 1 elements
   _V[_qp](4,5) = _C[_qp](0,2,0,1);
  
  // Due to major symmetry _C = C_klij 
  _V[_qp](5,4) = _V[_qp](4,5);
