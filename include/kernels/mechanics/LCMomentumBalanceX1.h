...
class LCMomentumBalanceX1;

template <>
InputParameters validParams<LCMomentumBalanceX1>();
/**
 * Kernel to implement momentum balance in two phase
 * material
 **/
class LCMomentumBalanceX1 : public Kernel
{
public:
  LCMomentumBalanceX1(const InputParameters & parameters);
