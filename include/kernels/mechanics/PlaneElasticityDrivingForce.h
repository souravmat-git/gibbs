...
class PlaneElasticityDrivingForce;

template<>
InputParameters validParams<PlaneElasticityDrivingForce>();
...
class PlaneElasticityDrivingForce :  public Kernel
{
  public: 
    PlaneElasticityDrivingForce(const InputParameters & parameters);
