...
class PlaneElasticity2PMomentumBalanceX;

template <>
InputParameters validParams<PlaneElasticity2PMomentumBalanceX>();
 ...
 */
class PlaneElasticity2PMomentumBalanceX : public PlaneElasticityTwoPhaseBase
{
public:
  PlaneElasticity2PMomentumBalanceX(const InputParameters & parameters);
