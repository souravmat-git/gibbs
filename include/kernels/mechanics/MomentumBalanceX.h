...
class MomentumBalanceX;

template <>
InputParameters validParams<MomentumBalanceX>();
 ...
 */
class MomentumBalanceX : public Kernel
{
public:
  MomentumBalanceX(const InputParameters & parameters);
