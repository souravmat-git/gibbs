...
class QMomentumBalance1DFun;
class Function;

template <>
InputParameters validParams<QMomentumBalance1DFun>();
 ...
 * material
 */
class QMomentumBalance1DFun : public Kernel
{
public:
  QMomentumBalance1DFun(const InputParameters & parameters);
