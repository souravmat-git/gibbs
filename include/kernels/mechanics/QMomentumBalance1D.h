...
class QMomentumBalance1D;
template <>
InputParameters validParams<QMomentumBalance1D>();
 ...
 * material
 */
class QMomentumBalance1D : public Kernel
{
public:
  QMomentumBalance1D(const InputParameters & parameters);
