...
class TwoDimEqualPhaseTractionVectorX;
 ...
 * in the x-direction
 */
class TwoDimEqualPhaseTractionVectorX : public ObtainUnitNormalBase
{
  public:
    TwoDimEqualPhaseTractionVectorX(const InputParameters & parameters);
