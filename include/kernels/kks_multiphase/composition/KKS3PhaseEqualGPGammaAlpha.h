...
#ifndef KKS3PHASEEQUALGPGAMMAALPHA_H
#define KKS3PHASEEQUALGPGAMMAALPHA_H

#include "Kernel.h"
#include "DerivativeMaterialInterface.h"

class KKS3PhaseEqualGPGammaAlpha;

template<>
InputParameters validParams< KKS3PhaseEqualGPGammaAlpha>();

/**
  *This class enforces the following 
  *Equation in the KKS model
  *df/dphi = dh_{gamma}/dphi_{alpha} * (omega_gamma - omega_alpha)
  *omega_beta - Grandpotential of the gamma phase
  *omega_alpha - GrandPotential of the alpha phase
  **/

class  KKS3PhaseEqualGPGammaAlpha : public Kernel

{
  public: 
     KKS3PhaseEqualGPGammaAlpha(const InputParameters & parameters);
...
#endif // KKS3PHASEEQUALGPGAMMAALPHA_H
