...
#ifndef KKS3PHASEEQUALGPGAMMABETA_H
#define KKS3PHASEEQUALGPGAMMABETA_H

#include "Kernel.h"

class KKS3PhaseEqualGPGammaBeta;

template<>
InputParameters validParams< KKS3PhaseEqualGPGammaBeta>();
...
class  KKS3PhaseEqualGPGammaBeta :  public Kernel
{
  public: 
     KKS3PhaseEqualGPGammaBeta(const InputParameters & parameters);
