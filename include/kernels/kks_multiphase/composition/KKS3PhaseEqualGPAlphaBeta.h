...
#ifndef KKS3PHASEEQUALGPALPHABETA_H
#define KKS3PHASEEQUALGPALPHABETA_H

#include "Kernel.h"

class KKS3PhaseEqualGPAlphaBeta;

template<>
InputParameters validParams< KKS3PhaseEqualGPAlphaBeta>();

/**
  *This class enforces the following 
  *Equation in the KKS model
  *df/dphi = dh_{alpha}/dphi_{beta} * (omega_alpha - omega_beta)
  *omega_beta - Grandpotential of the beta phase
  *omega_alpha - GrandPotential of the alpha phase
  **/

class  KKS3PhaseEqualGPAlphaBeta :  public Kernel
{
  public: 
     KKS3PhaseEqualGPAlphaBeta(const InputParameters & parameters);
...
#endif // KKS3PHASEEQUALGPALPHABETA_H
