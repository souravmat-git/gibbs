...
class MultiPhaseDoubleWell;

template <>
InputParameters validParams<MultiPhaseDoubleWell>();

/**
 * Kernel to implement double well
 */
class MultiPhaseDoubleWell : public Kernel
{
public:
  MultiPhaseDoubleWell(const InputParameters & parameters);
