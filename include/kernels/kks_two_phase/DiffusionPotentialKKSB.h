...
#ifndef DIFFUSIONPOTENTIALKKSB_H
#define DIFFUSIONPOTENTIALKKSB_H

#include "BinaryDiffusionPotentialKKS.h"

class DiffusionPotentialKKSB;

template<>
InputParameters validParams<DiffusionPotentialKKSB>();
...
class DiffusionPotentialKKSB :  public BinaryDiffusionPotentialKKS
{
  public: 
    DiffusionPotentialKKSB(const InputParameters & parameters);
