...
class BinaryPhaseDiffusionPotentialKKSFun;
class Function;

template <>
InputParameters validParams<BinaryPhaseDiffusionPotentialKKSFun>();
 ...
 */
class BinaryPhaseDiffusionPotentialKKSFun : public Kernel{
  public:
    BinaryPhaseDiffusionPotentialKKSFun(const InputParameters & parameters);
