...
#ifndef BINARYPHASECONSTRAINT_H
#define BINARYPHASECONSTRAINT_H

//Include dependencies
#include "Kernel.h"

// Forward Declarations
class BinaryPhaseConstraint;

template <>
InputParameters validParams<BinaryPhaseConstraint>();
/**
 ...
 **/
class BinaryPhaseConstraint : public Kernel
{
public:
  BinaryPhaseConstraint(const InputParameters & parameters);
