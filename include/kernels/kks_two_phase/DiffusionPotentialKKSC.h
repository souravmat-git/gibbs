...
#ifndef DIFFUSIONPOTENTIALKKSC_H
#define DIFFUSIONPOTENTIALKKSC_H

#include "Kernel.h"

class DiffusionPotentialKKSC;

template<>
InputParameters validParams<DiffusionPotentialKKSC>();
...
class DiffusionPotentialKKSC :  public Kernel
{
  public: 
    DiffusionPotentialKKSC(const InputParameters & parameters);
  ...
  private:  
    ...
    const VariableValue & _xC_gamma;
    unsigned int _xC_gamma_var;
...
#endif // _DIFFUSIONPOTENTIALKKSC_H
