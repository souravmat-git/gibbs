...
class DrivingForceLarcheCahn;

template<>
InputParameters validParams<DrivingForceLarcheCahn>();
...
class DrivingForceLarcheCahn : public AuxKernel
{
public:
  DrivingForceLarcheCahn(const InputParameters & parameters);
