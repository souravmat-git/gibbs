...
class QBetaPhaseElasticMaterial;
...
template <>
InputParameters validParams<QBetaPhaseElasticMaterial>();

class QBetaPhaseElasticMaterial : public Material
{
public:
  QBetaPhaseElasticMaterial(const InputParameters & parameters);
