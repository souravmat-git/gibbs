...
class ComputeMultiPlasticityStressPhase;
...
class ComputeMultiPlasticityStressPhase : public ComputeStressBase, public MultiPlasticityDebugger
{
public:

  static InputParameters validParams();
  ComputeMultiPlasticityStressPhase(const InputParameters & parameters);
