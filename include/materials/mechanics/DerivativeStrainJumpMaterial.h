...
class DerivativeStrainJumpMaterial;
...
template <>
InputParameters validParams<DerivativeStrainJumpMaterial>();

class DerivativeStrainJumpMaterial : public Material
{
public:
  DerivativeStrainJumpMaterial(const InputParameters & parameters);
