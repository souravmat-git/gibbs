...
class ComputeSmallStrainBeta;

//MOOSe includes
#include "ComputeStrainBase.h"

//template <>
//InputParameters validParams<ComputeSmallStrainBeta>();

class ComputeSmallStrainBeta : public ComputeStrainBase
{
public:
  ComputeSmallStrainBeta(const InputParameters & parameters);
