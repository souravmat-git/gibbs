...
class ScalarStrainJumpMaterial;

//MOOSe includes
#include "Material.h"

template <>
InputParameters validParams<ScalarStrainJumpMaterial>();

class ScalarStrainJumpMaterial : public Material
{
public:
  ScalarStrainJumpMaterial(const InputParameters & parameters);
