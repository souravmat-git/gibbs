...
class ElasticProperties3PAlpha;
...
template <>
InputParameters validParams<ElasticProperties3PAlpha>();

class ElasticProperties3PAlpha : public Material
{
public:
  ElasticProperties3PAlpha(const InputParameters & parameters);
