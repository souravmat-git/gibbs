...
class ElasticProperties3PBeta;

//MOOSe includes
#include "Material.h"

//template <>
//InputParameters validParams<ElasticProperties3PBeta>();

class ElasticProperties3PBeta : public Material
{
public:
  ElasticProperties3PBeta(const InputParameters & parameters);
