...
class ComputeSmallStrain3PAlpha;

//MOOSe includes
#include "ComputeStrainBase.h"

//template <>
//InputParameters validParams<ComputeSmallStrain3PAlpha>();

class ComputeSmallStrain3PAlpha : public ComputeStrainBase
{
public:
  ComputeSmallStrain3PAlpha(const InputParameters & parameters);
