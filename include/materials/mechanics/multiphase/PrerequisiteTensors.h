...
class PrerequisiteTensors;

//MOOSe includes
#include "VariableUnitNormalBase.h"

template <>
InputParameters validParams<PrerequisiteTensors>();

class PrerequisiteTensors : public VariableUnitNormalBase
{
public:
  PrerequisiteTensors(const InputParameters & parameters);
