...
class MultiPhaseVoigtTaylorHomogenization;

//MOOSe includes
#include "Material.h"

template <>
InputParameters validParams<MultiPhaseVoigtTaylorHomogenization>();

class MultiPhaseVoigtTaylorHomogenization : public Material
{
public:
  MultiPhaseVoigtTaylorHomogenization(const InputParameters & parameters);
