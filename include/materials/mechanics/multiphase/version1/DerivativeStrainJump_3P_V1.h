...
class DerivativeStrainJump_3P_V1;

//MOOSe includes
#include "Material.h"

//template <>
//InputParameters validParams<DerivativeStrainJump_3P_V1>();

class DerivativeStrainJump_3P_V1 : public Material
{
public:
  DerivativeStrainJump_3P_V1(const InputParameters & parameters);
