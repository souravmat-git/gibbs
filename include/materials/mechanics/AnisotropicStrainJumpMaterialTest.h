...
class AnisotropicStrainJumpMaterialTest;
...
template <>
InputParameters validParams<AnisotropicStrainJumpMaterialTest>();

class AnisotropicStrainJumpMaterialTest : public Material
{
public:
  AnisotropicStrainJumpMaterialTest(const InputParameters & parameters);
