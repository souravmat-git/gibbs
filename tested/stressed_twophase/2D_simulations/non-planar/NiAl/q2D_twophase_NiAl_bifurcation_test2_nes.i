...
[Mesh]
  [concentric_ring]
    ...
    num_sectors = 10
    radii = '14.7'          #I assume that this is the radius
...
[Materials]
  ...
  [./consts]
    ...
    prop_values = '8.636181e-4  450.0    1.0   25.5708    8673.252556'
  [../]
...
[Outputs]
  ...
  file_base = q2D_twophase_NiAl_bifurcation_test2_nes
  #exodus = true
