#This test problem simply simulates
#using the grand-potential model
#For this we simply set the eigenstrain
#to zero, then the mechanical problem is removed
#T = 1473 K
#Length = 10e-6 m
...
[VectorPostprocessors]
   [./fields]
    ...
    end_point = '4410 0 0'
    sort_by = id
    variable = 'eta x_Al interface_energy'
   [../]
...
[Outputs]
  ...
  file_base = q1D_twophase_NiAl_nes_ti2
  #exodus = true
