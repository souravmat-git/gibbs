...
[Kernels]
 ...
 [./BinaryMultiPhaseDrivingForce_alphabeta]
  ...
  [./QDrivingForceGradPhiPhaseAlpha]
     type = QDrivingForceGradPhiPhase
     variable = phi_alpha
     base_name = alpha
     mob_name = L_phi
     nd_factor = ndf_el
 ...
 [./BinaryMultiPhaseDrivingForce_gammabeta]
  ...
  [./QDrivingForceGradPhiPhaseGamma]
     type = QDrivingForceGradPhiPhase
     variable = phi_gamma
     base_name = gamma
     mob_name = L_phi
...
[Materials]
 ...
 [./ConstantFieldProperties]
   ...
   prop_values = '5.415e-04    72.0    1.0   44.341   22153.846'
 [../]
  ...
  [./DrivingForceGradPhiTheta]
    type = DrivingForceGradPhiTheta
    phase_alpha = phi_alpha
    phase_beta  = phi_beta
    phase_gamma = phi_gamma
  [../]
...
[VectorPostprocessors]
   [./fields]
    ...
    end_point = '3000 0 0'
    sort_by = id
    variable = 'phi_alpha phi_beta phi_gamma x_Al ux uy'
   [../]
...
[Outputs]
  ...
  file_base = anisotropic_strain_jump_2D_me_var
  #exodus = true
