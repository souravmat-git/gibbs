...
[AuxKernels]
  ...
  [./strain_jump_alpha_beta_xx]
   type = RankTwoAux
   variable = strain_jump_alpha_beta_xx
   rank_two_tensor = strain_jump_alpha_beta
   index_i = 0
   index_j = 0
  [../]
...
[Materials]
 ...
 [./ConstantFieldProperties]
   ...
   prop_values = '1.283e-03    40.5    1.0   33.256   16615.385'
 [../]
 ...
 [../]
  ...
  [./MultiPhaseVoigtTaylorHomogenization]
    type = MultiPhaseVoigtTaylorHomogenization
    #phase_alpha = phi_alpha
    #phase_beta  = phi_beta
    #phase_gamma = phi_gamma
    #outputs = exodus
...
[Outputs]
  ...
  file_base = anisotropic_strain_jump_2D_VTS
  #exodus = true
