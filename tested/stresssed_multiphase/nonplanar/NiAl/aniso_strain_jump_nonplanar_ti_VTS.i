...
#And then combines with a VTS scheme
...
[Mesh]
  [concentric_ring]
    ...
    num_sectors = 10
    radii = '2'           #I assume that this is the radius
...
[Materials]
 ...
 [./ConstantFieldProperties]
   ...
   prop_values = '4.332e-3    18.0    1.0  22.171     11076.923'
 [../]
...
[Outputs]
  ...
  file_base = aniso_strain_jump_nonplanar_ti_VTS
  #exodus = true
