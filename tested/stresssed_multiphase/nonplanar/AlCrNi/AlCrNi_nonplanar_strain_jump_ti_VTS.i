...
#Note that radii_start*num_circles = 900 which is the
#nondimensional outer radius (= 30e-6 m)
#Interface width = 0.3e-6 m
...
[Mesh]
  [concentric_ring]
    ...
    num_sectors = 10
    radii = '1.5'         #I assume that this is the radius
...
[Materials]
  ##Phenomenological coeff###
   ...
   [./ConstantFieldProperties]
     ...
     prop_values = '1.369    10.125   1    16.329    8404.040'
  [../]
...
[Outputs]
  ...
  file_base = AlCrNi_nonplanar_strain_jump_ti_VTS
