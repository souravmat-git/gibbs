...
[ICs]
 ...
 #Al_outside = alpha(right)
  ...
  [./ic_func_xAl]
   ...
   x2 = 0.0
   y2 = 0.0
   inside =  2.5E-1         #xAl_L12 = 2.37162E-1
   outside = 1.0E-4         #xAl_FCC = 1.24644E-1    
  [../]
...
[Materials]
  ##Phenomenological coeff###
   ...
   [./ConstantFieldProperties]
     ...
     prop_values = '0.0212     4.5     1.0    326.5739'
  [../]  
...
[UserObjects]
  ...
  [./table_L12_data]
    ...
    table_name = NiAl_data/NiAl_invert_data_L12_1473.csv
  [../]
  
  [./table_FCC_data]
    type = BinaryConjugatePhaseData
    table_name = NiAl_data/NiAl_invert_data_FCC_1473.csv
  [../] 
  
  [./table_L12_mobility_data]
    type = BinaryConjugateMobilityData
    table_name = NiAl_data/NiAl_mobility_data_L12_invert_1473.csv
  [../]
  
  [./table_FCC_mobility_data]
    type = BinaryConjugateMobilityData
    table_name = NiAl_data/NiAl_mobility_data_FCC_invert_1473.csv
  [../] 
...
[Outputs]
  ...
  file_base = NiAl_twophase_1473_iw
  #exodus = true
