...
#This is two-phase Al-Cr-Ni-Fe substitutional alloy problem
#beta phase - FCC_A1
#alpha phase- BCC_A2
#T = 1473K
#Simulation details:
#Interfacial energy = 0.5 J/m2
#interfacial width = 1.25e-6 m
#Length = 250e-6 m
#characteristic_length = (0.25e-6)/6.0 = 0.04167e-6 m
#characteristic_time = 3.8171 sec
...
[Materials]
  ##Phenomenological coeff##
   ...
   [./ConstantFieldProperties]
     ...
     prop_values = '0.0077      112.5   1.0   68.0362 '
  [../] 
...
[Executioner]
  ...
  end_time = 2.26349847E6 #non-dimensional
  #dt = 1
  
  [./TimeStepper]
    type = SolutionTimeAdaptiveDT
    percent_change = 0.1
    dt = 10.0 #real_dt = 0.1sec
  [../]
...
[Outputs]
  ...
  file_base = AlCrNiFe_twophase_ti_2
  #exodus = true
