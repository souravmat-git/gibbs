...
#This is a model five-phase Ni-Al alloy problem
#alpha phase- FCC_A1
#beta phase - FCC_L12
#gamma phase- BCC_B2
#delta phase- Al3NI2
...
[Functions]
  ...
  [./func_phi_alpha]
    type = ParsedFunction
    value = 'if(x<=-200 & y>=-300 & y<=300 , 1.0, 0)'
  [../]
  
  [./func_phi_beta]
    type = ParsedFunction
    value = 'if(x>-200 & x<=0.0 & y>=-300 & y<=300, 1.0, 0)'
  [../]
  
  [./func_phi_gamma]
    type = ParsedFunction
    value = 'if(x>0 & x<=100 & y>=-300 & y<=300, 1.0, 0)'
  [../]
  
  [./func_phi_delta]
    type = ParsedFunction
    value = 'if(x>100 & x<=200 & y>=-300 & y<=300, 1.0, 0)'
  [../]
...
[Materials]
  ...
  #characteristic_Onsager_constant Lc = 9.2808e-22 molm2/Js
    ...
    [./ConstantFieldProperties]
     ...
     prop_values = '2.2772e-4   112.5  1.0  55.4267   1.35e-2        1.35e-2     1.35e-2'
  [../]
...
[Outputs]
  ...
  file_base = NiAl_diffusion_couple_2D
  exodus = true
