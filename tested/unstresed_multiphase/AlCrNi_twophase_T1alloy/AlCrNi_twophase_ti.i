...
#Length = 200e-6 m
#characteristic_length = 0.03333e-6 m
#characteristic_time = 4.4706 s
...
[Functions]
  ...
  [./func_xCr]
    ...
    vars = 'alpha beta'
    vals = 'func_phi_alpha  func_phi_beta'
    value = '9.54264E-1*alpha + 3.731485E-1*beta'
  [../]
  ...
  [./func_muAl]
    ...
    vars = 'alpha beta'
    vals = 'func_phi_alpha  func_phi_beta'
    value = '-8.13286E0*alpha -6.51209298E0*beta'
  [../]
  ...
  [./func_muCr]
    ...
    vars = 'alpha beta'
    vals = 'func_phi_alpha  func_phi_beta'
    value = '2.83095E0*alpha + 2.35360328E0*beta'
  [../]
[]
...
[Materials]
  ...
  [./ConstantFieldProperties]
     ...
     prop_values = '0.0106   112.5  1.0   54.4290 '
  [../]
...
[Executioner]
  ...
  #Real time 1day = 7.72594361E2
  #Real time 150 days = 2.89893974e6
