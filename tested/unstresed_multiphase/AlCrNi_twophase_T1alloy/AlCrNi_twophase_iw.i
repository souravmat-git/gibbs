...
#interfacial width = 0.2e-6 m
#Length = 200e-6 m
#characteristic_length = (0.2e-6/6.0) = 0.03333e-6
...
[Functions]
  ...
  [./func_muCr]
    ...
    vars = 'alpha beta'
    vals = 'func_phi_alpha  func_phi_beta'
    value = '2.83095E0*alpha + 2.356303328E0*beta'
  [../]
[]
...
[Materials]
  ...
  [./ConstantFieldProperties]
     ...
     prop_values = '1.3228   4.5    1.0    10.8858'
  [../]
...
[Executioner]
  ...
  #Real time 1day = 1.93262649E4 
  #Real time 150day = 2.89893974e6
