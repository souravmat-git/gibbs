#This input properties are provided in a tabulated format
#as functions of Al-diffusion potential.
#This is a model Ni-Al five-phase alloy problem
#alpha phase - FCC_A1
#beta phase  - FCC_L12
#gamma phase - BCC_B2
#delta phase - Al3Ni2
...
#interfacial width = 0.3e-6 m
#Length = 300e-6 m
#characteristic_length = 0.05e-6 m
#charactersitic_time  = 324 sec 
...
# Width of gamma_prime = 20 mu m
# Width of NiAl (B2 phase)= 10 mu m
# Width of Al3Ni2 = 10 mu m
  ...
  [./func_xAl]
    ...
    value = '1.28E-1*alpha + 2.4E-1*beta + 5.41418E-1*gamma + 6.80224E-1*delta + 8.93138E-1*epsilon'
  [../]
...
[Materials]
  ...
  #nd_factor = R*T/(Vm*m)
    ...
    [./ConstantFieldProperties]
     ...
     prop_values = '0.0285   4.5    1.0  11.0853   1.35e-2     1.35e-2     1.35e-2'
  [../]
 ...
 [../] 
  ...
  #[./BinaryCojugateKineticMaterial_Al3Ni2]
  #  type = BinaryConjugateKineticMaterial
  #  L_BB = L_BB_delta_tc
  #  dL_BB_muB = dL_BB_muB_delta_tc
  #  B_diff_pot = mu_Al
  #  table_object = table_FCC_mobility_data
  #[../]
...
[Executioner]
  ...
  #non-dimensional time = 1.11111111e4
  #real-time = 1000hr

  end_time = 1.7e6 #non-dimensional
...
[Outputs]
  ...
  file_base = NiAl_diffusion_couple_iw
  exodus = true
