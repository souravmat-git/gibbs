...
#interfacial width = 0.75 e-6 m
#Length = 250e-6 m
#characteristic_length = (0.25e-6)/6.0 m = 0.04167e-6 m
...
[Materials]
  ##Phenomenological coeff##
   ...
   [./ConstantFieldProperties]
     ...
     prop_values = '0.0975  40.5    1.0   40.8217E0'
  [../] 
 
 ######################################
 
 [./QuaternaryConstantKineticMaterial_FCC]
...
[Executioner]
  ...
  end_time = 9.54696133e6 #non-dimensional
  #dt = 1
  
  [./TimeStepper]
    type = SolutionTimeAdaptiveDT
    percent_change = 0.1
    dt = 100E0 #real_dt = 0.1sec
  [../]
...
[Outputs]
  ...
  file_base = AlCrNiFe_intermediate_ti
  exodus = true
